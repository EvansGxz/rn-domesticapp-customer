...
export default function SelectService() {
  ...
  return (
    <View style={SharedStyles.mainScreen}>
      ...
      <View
        style={[{ paddingHorizontal: 35, paddingTop: 20 }, SharedStyles.fill]}
      >
        <Text style={[SharedStyles.h3, { marginBottom: 10 }]}>
          Tipo de jornada *
        </Text>
        <Picker
      ...
      <View style={[SharedStyles.mainPadding, SharedStyles.centerContent]}>
        ...
        <Button
          style={SharedStyles.backgroundPrimary}
          onPress={() =>
            navigation.navigate("ServiceCalendar", {
              ...route.params,
              workingDayType: selectedValue,
            })
          }
        >
          Continuar
